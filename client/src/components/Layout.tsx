    ...
    <div className="min-h-screen flex flex-col">
      ...
      <footer className="border-t border-gray-800 bg-gray-900/60 py-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            {social.telegramUrl && (
              <a href={social.telegramUrl} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-blue-400 transition" aria-label="Telegram">
            ...
            {social.whatsappUrl && (
              <a href={social.whatsappUrl} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-green-400 transition" aria-label="WhatsApp">
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
